...
export const DevelopmentPage = () => {
  ...
  const state = {
    main: {
      ...
      subtitle: `Билл Гейтс однажды сказал: «Если у Вашей компании нет сайта, у вас нет бизнеса»`,
      image,
    },
    ...
    advantages: {
      ...
      items: [
        ...
        },
        {
          ...
          subtitle:
            "Вам не нужно платить сразу за весь проект. Оплата может происходить поэтапно с персональным подходом.",
        },
      ],
    },
    ...
    text: {
      title:
        "Сайт сегодня – не только визитка компании, это эффективный маркетинговый инструмент, техническое дополнение к бизнесу и эффективный метод коммуникации с клиентами. Потенциальные клиенты и работники, партнеры, инвесторы и СМИ точно так же, как и вы пользуются поисковиками. И если вас в этой поисковой выдаче нет, все они перейдут на сайт к конкуренту.",
    },
